...
### `/src/main/sql`
This contains (Postgre)SQL-based transformation scripts. It provides a script to automatically extract the observation period,
and a simpler `sample_script.sql` to demonstrate the use of the `execute_sql_file` wrapper method.
